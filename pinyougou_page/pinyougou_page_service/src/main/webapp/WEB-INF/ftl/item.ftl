...
<body ng-app="pinyougou" ng-controller="pageController" ng-init="num=1;loadSKU()">

<#include "head.ftl">
<#assign itemImages = goodsDesc.itemImages?eval>
<#assign customAttributeItems = goodsDesc.customAttributeItems?eval>
<#assign specItemList = goodsDesc.specificationItems?eval>
		...
		<div id="item">
			<div class="crumb-wrap">
				<ul class="sui-breadcrumb">
					...
					<li class="active">${category3Name}</li>
				</ul>
			</div>
			<!--product-info-->
				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<span class="jqzoom"><img jqimg="${itemImages[0].url}" src="${itemImages[0].url}" height="300px" width="400px"/></span>
						</div>
						</#if>
						<!--下方的缩略图-->
						...
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
									...
									<#list specList.attributeValue as value>
										<dd><a href="javascript:;" class="{{isSelectSpec('${specList.attributeName}','${value}')?'selected':''}}" ng-click="updateSpecificationItems('${specList.attributeName}','${value}')">${value}<span title="点击取消选择">&nbsp;</span></a></dd>
									</#list>
							</dl>
							</#list>
						</div>
